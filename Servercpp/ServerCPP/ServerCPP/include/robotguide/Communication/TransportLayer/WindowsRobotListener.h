...
namespace robotguide::com::transportlayer
{
	...
	class WindowsRobotListener final : protected WindowsListener, public ISocket
	{
	private:
		IReceiver& receiver;
	...
	public:
		...
		WindowsRobotListener(IReceiver& receiver, IRobotInstructor& robotInstructor, const std::string& ipAddress, const std::string& port, const addrinfo& type);
